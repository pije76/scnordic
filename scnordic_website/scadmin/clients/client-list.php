                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
							<td><?php echo $i ?></td>
							<td>
							<a href="<?php echo BASE_ADMIN_URL_NEW ;?>home.php?page=query_edit&id=<?php echo $row['query_id']; ?>" class="badge btn-info btn-sm" role="button" title="Edit" data-toggle="tooltip" name='edit'>
							<i class="fa fa-pencil"></i>
							</a>
						
							<a href="<?php echo BASE_ADMIN_URL_NEW ;?>masterprocess.php?action=query_delete&p_id=<?php echo $row['query_id']; ?>" class="badge btn-danger btn-sm delete"  role="button" title="Delete" name="delete" data-toggle="tooltip">
