...
if(isset($_GET['role_id']) ) {
	$sql = "SELECT * from role WHERE role_id=".$_GET['role_id']."" ;
                ...
                <div class="col-md-12">               
				 ...
				 <input type="hidden" id="role_id" name="role_id" class="form-control" value="<?php echo $row['role_id']; ?> ">
                        ...
                        <div class="row form-group">
					      ...
					      <input type="text" id="title" name="title" class="form-control required" placeholder="Role Name" />
					...
					<input type="text" id="accesses" name="accesses" class="form-control disabled required" style="background-color: #eee;" placeholder="Accesses" value="<?php echo $y;?>">
                          </div>
                        </div>
				...
				<div class="row form-group">
					...
					<tr>
					 ...
					 <input type="checkbox" name="check_role" class="test" value="rentsecurityreport" <?php if(in_array('rentsecurityreport', $x)) {echo 'checked';} ?>> Rent/Secuirty Report
                          ...
                          <div class="row form-group">
                            <div class="col-md-6">
                               <input type="submit" name="role_submit" value="Submit" id="rnole_submit" class="btn btn-primary text-uppercase sign-up"/>
                            </div>
                          </div>
                        </form>
                      </div>
