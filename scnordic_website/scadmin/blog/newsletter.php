<?php 
$sql111 = "Select * from newsletter ORDER BY created_date DESC " ;
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
							<td><?php echo $i ?></td>
							<td>
							<a href="<?php echo BASE_ADMIN_URL_NEW ;?>masterprocess.php?action=newsletter_delete&p_id=<?php echo $row['n_id']; ?>" class="badge btn-danger btn-sm delete"  role="button" title="Delete" name="delete" data-toggle="tooltip">
